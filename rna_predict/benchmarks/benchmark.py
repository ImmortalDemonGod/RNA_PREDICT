...
def generate_synthetic_features(
    ...
    # Add unsqueeze(-1) to make shape (1, N_atom, 1)
    ...
    # Ensure it has shape (1, N_atom, 1) as expected by _process_feature
    ...
    # Token-level features should have shape [1, N_token, feature_dim]
