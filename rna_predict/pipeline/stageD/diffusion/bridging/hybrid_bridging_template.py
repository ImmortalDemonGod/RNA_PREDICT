...
def debug_print_hybrid_bridging_inputs(stage_c_output, residue_atom_map, n_residues, canonical_atom_count, feature_dim, batch_size, fill_value, device, debug_logging=False):
    print("[DEBUG][ENTRY] debug_print_hybrid_bridging_inputs called. debug_logging:", debug_logging)
...
def hybrid_bridging_sparse_to_dense(
    ...
    print("[DEBUG][ENTRY] hybrid_bridging_sparse_to_dense called. debug_logging:", debug_logging)
    """
    ...
    Args:
        ...
        device: torch.device
        debug_logging: Whether to print debug output
    Returns:
