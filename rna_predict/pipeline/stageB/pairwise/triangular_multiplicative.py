    ...
    def _inference_forward(
        ...
        if inplace_chunk_size is not None:
            ...
            for i, offset in combined_range_with_offsets:
                ...
                # Create a temporary copy to avoid in-place operation on overlapping memory
                temp_chunk = x_chunk.clone()
                if with_add:
                    # Add the current values to the temporary chunk
...
class FusedTriangleMultiplicativeUpdate(BaseTriangleMultiplicativeUpdate):
    ...
    def _inference_forward(
        ...
        # Create a new tensor to avoid in-place operations on overlapping memory
        result = z.clone()
        ...
        # Return the new tensor instead of modifying z in-place
        return result
