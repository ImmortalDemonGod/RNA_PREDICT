...
def register_configs() -> None:
    """
    Registers all configuration dataclasses with Hydra's ConfigStore for schema validation.
    
    This function ensures that each configuration schema used in the RNA prediction pipeline
    is available to Hydra for structured configuration management and validation.
    """
