...
class AtomAttentionEncoder(nn.Module):
    ...
    """
    def __init__(self, c_atom=128, c_pair=32, c_token=384, num_heads=4, num_layers=3, use_optimized=False):
        super().__init__()
        self.c_atom = c_atom
        self.c_pair = c_pair
        ...
        self.atom_transformer = AtomTransformer(
            c_atom=c_atom, num_heads=num_heads, num_layers=num_layers,
    ...
    def forward(self, f, trunk_sing=None, trunk_pair=None, block_index=None):
        ...
        same_entity = (token_ids.unsqueeze(1) == token_ids.unsqueeze(0)).float().unsqueeze(-1)
