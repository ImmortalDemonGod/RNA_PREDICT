...
TEST CODE: {TEST_CODE}
FULL SRC CODE: {FULL_SRC_CODE}

Where:
	•	{TEST_CODE} is the content of your automatically generated Python test files (potentially multiple files’ content combined or listed).
	•	{FULL_SRC_CODE} is the content of the source code under test (if needed for context).
