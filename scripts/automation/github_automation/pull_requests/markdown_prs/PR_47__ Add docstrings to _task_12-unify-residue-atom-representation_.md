# Pull Request #47: 📝 Add docstrings to `task/12-unify-residue-atom-representation`
...
There are 3 ways to chat with [CodeRabbit](https://coderabbit.ai?utm_source=oss&utm_medium=github&utm_campaign=ImmortalDemonGod/RNA_PREDICT&utm_content=47):
