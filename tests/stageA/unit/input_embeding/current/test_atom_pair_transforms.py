...
class TestAtomPairTransforms:
    ...
    def sample_data(self):
        ...
        for b in range(batch_size):
            for t in range(n_tokens):
                atom_to_token_idx[b, t*n_atoms_per_token:(t+1)*n_atoms_per_token] = t
    ...
    def test_map_tokens_to_atoms(self, sample_data):
        ...
        assert result.shape == (token_feats.shape[0], expected_atoms, token_feats.shape[2])
    ...
    def test_broadcast_token_to_local_atom_pair_with_config(self, sample_data):
        ...
        assert result.shape == (token_feats.shape[0], n_atoms, n_atoms, token_feats.shape[2] * 2)
